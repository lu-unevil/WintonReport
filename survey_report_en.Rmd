...
```
<br>
Rescaling of questions on 1..5 scale is done with $NewScore = OldScore * 1.5 - 0.5$. One of the question is stated with negation (i.e. "will NOT affect"), so the answers need to be inverted with $max(OldScore)+1-OldScore$. Once the scores are rescaled they can be averaged across the answers to the questions in the table above. 
