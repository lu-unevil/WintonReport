...
## Riskperception of COVID-19 compared to other issues - direct and personal effects

```{r personal_1, fig.width=12, fig.height=18}

```

## Riskuppfattning av COVID-19 compared to other issues - direct and personal effects
