...
Vi presenterar här resultaten från de två tillfällena så att det är möjligt att jämföra. Generellt sett är det ingen stor skillnad mellan svaren från april jämfört med mars. Just nu arbetar forskare med analys av detta material. Data är offentlig för att göra det möjligt för beslutsfattare att bilda sig en uppfattning om hur vi upplever COVID-19. Vi har gjort en liknande [översikt av publika data i samma studie från flera länder] (https://lu-unevil.github.io/WintonReport/WintonReport-en.html).
...
```{details, echo=FALSE, lang="md", details.summary='Wilcox test'}
wilcox_details("CanadaQ")
```
