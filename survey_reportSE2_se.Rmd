...
Här följer en sammanställning av vad data visar.  

## Uppfattning av effekter av COVID-19

Var fjärde person har upplevt ekonomiska svårigheter som ett resultat av pandemin. Andelen var något färre i april jämfört med mars. Det är lika många som har upplevt sociala svårigheter som inte har gjort det. Färre än 25% har upplevt svårigheter i sin mentala hälsa som ett resultat av pandemin. Ca 75% har inga vänner eller familj som testats positiva eller dött av viruset.
...
Tre utav fyra skulle rekommendera utsatta vänner och familj att bli vaccinerade, skulle ett vaccin bli tillgänglig för COVID-19, men något lägre kan tänka sig att själva låta sig bli vaccinerad.
...
Jämförelser i svar mellan mars och april är testade med en signifikansnivå på 0.001.
