...
Omskalning av frågor på skalan 1..5 görs med $NewScore = OldScore * 1.5 - 0.5$. En av frågorna anges med negation (dvs "kommer INTE att påverka"), så svaren måste inverteras med $max (OldScore) + 1-OldScore$. När poängen har räknats om kan de beräknas i genomsnitt över svaren på frågorna i tabellen ovan.

Nu kan vi jämföra fördelningen av riskindex.
...
idx_plt_df <- tibble::tribble(~language, ~item, ~txt,
                              ...
                              "se", "title", "Riskuppfattningsindexfördelning",
